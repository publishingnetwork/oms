<div class="row-fluid">
	...
	<div class="filter-container">
		<form class="form-inline " id="date-range" action="<?php echo URL::base(); ?>order" method="get">
			...
			<input type="hidden" placeholder="End"  name="filter" value="<?php echo $filter; ?>">
                        <input type="hidden" name="paypal_account" value="<?php echo $paypal_account; ?>">
	...
	<div class="filter-container">
		...
		<ul class="nav nav-pills" id="type-filter">
			...
			<li data-filter="paypal" class="<?php echo $filter == 'paypal' ? 'active' : ''; ?> paypal-filter-button"><a href="#" id="show-paypal">PayPal</a></li>
                        <li>
                            <select name="paypal_account" id="paypal_account" class="input-medium" data-value="<?php echo $paypal_account; ?>">
                                    <option value="any">Any</option>
                                    <option value="admin@thealkalinediet.org">admin@thealkalinediet.org</option>
                                    <option value="payment@holistichealthlabs.com">payment@holistichealthlabs.com</option>
                            </select>
                        </li>
